"""Build deterministic release envelope for Φ-Compiler / ScienceAtlas 15.26.0."""
...
RELEASE='15.26.0'; OWNER='RELEASE-CONTROLS/15.26.0'
...
def run(root=None):
 ...
 if q.get('status')!='PASS_CURRENT_STATE_15_26_0': raise RuntimeError('current-state qualification failed')
 ...
 tree=['# FILE TREE — CURRENT 15.26.0','',f'Controlled files: {len(files)}','']+[f"- `{r['path']}`" for r in files]
