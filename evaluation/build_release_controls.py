"""Build deterministic release envelope for Φ-Compiler / ScienceAtlas 15.24.0."""
...
def run(root=None):
 ...
 tree=['# FILE TREE — CURRENT 15.24.0','',f'Controlled files: {len(files)}','']+[f"- `{r['path']}`" for r in files]
