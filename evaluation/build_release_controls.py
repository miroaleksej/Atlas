"""Build deterministic release envelope for Φ-Compiler / ScienceAtlas 0.15.27.0."""
...
RELEASE='0.15.27.0'; OWNER='RELEASE-CONTROLS/0.15.27.0'
...
def run(root=None):
 ...
 if q.get('status')!='PASS_CURRENT_STATE_15_27_0': raise RuntimeError('current-state qualification failed')
 ...
 tree=['# FILE TREE — CURRENT 0.15.27.0','',f'Controlled files: {len(files)}','']+[f"- `{r['path']}`" for r in files]
